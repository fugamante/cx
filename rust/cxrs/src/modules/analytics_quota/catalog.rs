...
fn embedded_quota_catalog() -> Value {
    ...
    json!({
        ...
        "entries": [
            { "provider":"openai", "backend":"primary", "tier":"free", "service_kind":"remote_metered", "limit_type":"dynamic", "quota_total_tokens": null, "window_days": null, "source_url":"https://help.openai.com/en/articles/11909943-gpt-53-and-52-in-chatgpt", "retrieved_at": now, "notes":"Public ChatGPT limits are product/tier-dependent and can change." },
            { "provider":"openai", "backend":"primary", "tier":"plus", "service_kind":"remote_metered", "limit_type":"dynamic", "quota_total_tokens": null, "window_days": null, "source_url":"https://help.openai.com/en/articles/11909943-gpt-53-and-52-in-chatgpt", "retrieved_at": now, "notes":"Plus limits may vary by model and rolling window." },
            { "provider":"openai", "backend":"primary", "tier":"pro", "service_kind":"remote_metered", "limit_type":"dynamic", "quota_total_tokens": null, "window_days": null, "source_url":"https://help.openai.com/en/articles/9793128/", "retrieved_at": now, "notes":"Pro may be described with dynamic or guardrail-based usage." },
            { "provider":"openai", "backend":"primary", "tier":"business", "service_kind":"remote_metered", "limit_type":"dynamic", "quota_total_tokens": null, "window_days": null, "source_url":"https://help.openai.com/en/articles/12003714-chatgpt-business-models-limits", "retrieved_at": now, "notes":"Business limits are model-specific and may be updated." },
