...
\begin{itemize}
  ...
  \item Orchestrator: \texttt{src/app.rs} (routing + composition).
  \item Core extracted command modules: \texttt{introspect}, \texttt{runtime\_controls}, \texttt{agentcmds}, \texttt{logview}, \texttt{analytics}, \texttt{diagnostics}, \texttt{routing}, \texttt{prompting}, \texttt{optimize}, \texttt{doctor}, \texttt{schema\_ops}, \texttt{settings\_cmds}.
